    ...
    <div>
      <footer className='relative overflow-hidden'>
        <div aria-hidden='true' className='flex absolute start-0 -z-[1]'>
          <div className='bg-purple-200 opacity-10 blur-3xl w-[1036px] h-[600px] dark:bg-purple-900 dark:opacity-20'></div>
          <div className='bg-slate-200 opacity-20 blur-3xl w-[577px] h-[300px] transform translate-y-32 dark:bg-slate-800/60'></div>
        </div>
