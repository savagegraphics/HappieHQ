...
//               className='text-blue-600 hover:underline dark:text-blue'
//             >
//               get started
//             </a>
...
//             <button
//               type='button'
//               className='mr-2 inline-flex items-center rounded-xl bg-green-700 px-3 py-1.5 text-center text-xs font-medium text-white hover:bg-green-800 focus:ring-4 focus:ring-green-300 dark:bg-green-800 dark:hover:bg-green-900'
//             >
...
//             <button
//               type='button'
//               className='rounded-xl border border-green-700 bg-transparent px-3 py-1.5 text-center text-xs font-medium text-green-700 hover:bg-green-800 hover:text-white focus:ring-4 focus:ring-green-300 dark:border-green-800 dark:text-green-800 dark:hover:text-white'
//             >
//               Dismiss
//             </button>
//           </div>
...
//       <Toast>
//         <div className='inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-green-100 text-green-500 dark:bg-green-800 dark:text-green-200'>
...
//       </Toast>
//       <Toast>
//         <div className='inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-red-100 text-red-500 dark:bg-red-800 dark:text-red-200'>
...
//       </Toast>
//       <Toast>
//         <div className='inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-orange-100 text-orange-500 dark:bg-orange-700 dark:text-orange-200'>
