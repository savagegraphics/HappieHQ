            ...
            <div className='relative mt-10 text-white'>
              ...
              <form className='mt-5 grid gap-6'>
                <div className='relative'>
                  ...
                  <label
                    className='peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 peer-checked:text-gray-700 flex cursor-pointer select-none rounded-xl border border-gray-300 p-4'
                    htmlFor='radio_1'
                  >
                    <img
