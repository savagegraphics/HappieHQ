              ...
              <div className='lg:flex lg:items-start'>
                ...
                <div className='mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0'>
                  <div className='flex flex-row items-start lg:flex-col'>
                    <button
                      type='button'
                      className='flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-xl border-2 border-gray-900 text-center'
                    >
                      <img
                    ...
                    <button
                      type='button'
                      className='flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-xl border-2 border-transparent text-center'
                    >
                      <img
                        className='h-full w-full object-cover'
                        src='/images/JHxMnVrtPMdcNU1s_7g7f.png'
              ...
              <div className='mt-3 flex select-none flex-wrap items-center gap-1'>
                <label className=''>
                  <input
                    ...
                    checked
                  />
                  <p className='peer-checked:bg-black peer-checked:text-white rounded-xl border border-black px-6 py-2 font-bold'>
                    Powder
                  </p>
                </label>
                <label className=''>
