    ...
    <div className='max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8'>
      <div className='grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center lg:m-2 m-4'>
        <div className='lg:col-span-3'>
          <h1 className='block text-xl font-bold text-gray-800 sm:text-3xl md:text-2xl lg:text-4xl'>
          ...
          <div className='mt-7 grid gap-3 w-full sm:inline-flex'>
            <Link
              className='py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-xl border border-transparent bg-blue-700 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none'
              href='/Auth'
            >
              Start Shipping
              <svg
            ...
            <a
              className='py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-xl border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none'
              href='#'
            >
              Get A Quote
            </a>
