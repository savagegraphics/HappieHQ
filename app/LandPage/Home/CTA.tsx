  ...
  return (
    <div className='w-full p-4 text-center bg-white border border-gray-200 rounded-xl shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700'>
      ...
      <div className='items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse'>
        <a
          href='#'
          className='w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-xl inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700'
        >
          <svg
