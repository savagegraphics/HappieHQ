    ...
    <div className='max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8'>
      <div className='grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-center lg:m-2 m-4'>
        <div className='lg:col-span-3 rounded-xl'>
          <div className='block rounded-xl text-xl font-bold text-gray-800 sm:text-3xl md:text-2xl lg:text-4xl'>
            {/* Skeleton for heading */}
            <div className='w-64 h-8 mb-4 rounded-xl bg-gray-300'></div>
          </div>
          <div className='mt-3 text-md rounded-xl text-gray-800'>
            {/* Skeleton for paragraph */}
            <div className='w-full h-6 mb-2 rounded-xl bg-gray-300'></div>
            <div className='w-full h-6 mb-2 rounded-xl bg-gray-300'></div>
            <div className='w-full h-6 mb-2 rounded-xl bg-gray-300'></div>
          </div>
          ...
          <div className='mt-7 rounded-xl grid gap-3 w-full sm:inline-flex'>
            ...
            <div className='w-36 h-12 rounded-xl bg-gray-300'></div>
          ...
          <div className='mt-6 lg:mt-12 rounded-xl'>
            ...
            <div className='mt-4 flex gap-x-8 rounded-xl'>
              ...
              <div className='w-20 h-16 rounded-xl bg-gray-300'></div>
              <div className='w-20 h-16 rounded-xl bg-gray-300'></div>
            </div>
          </div>
        </div>
        <div className='lg:col-span-4 mt-10 lg:mt-0 rounded-xl'>
          {/* Skeleton for image */}
          <div className='w-full h-96 rounded-xl bg-gray-300'></div>
        </div>
      </div>
    </div>
  )
